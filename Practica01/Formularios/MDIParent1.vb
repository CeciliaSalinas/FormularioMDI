...
Public Class MDIParent1
    ...
    'Tanto listaDeproductos y cargarVenta en esta instancia muestra el formulario cuando hago click
    ...
    Private Sub CargarVentaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CargarVentaToolStripMenuItem.Click
        Dim formularioVenta As FrmVentas = FrmVentas.getInstancia
        formularioVenta.MdiParent = Me
